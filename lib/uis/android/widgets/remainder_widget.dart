...
class _RemainderWidgetState extends State<RemainderWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    final remindersList = AlarmsAndSettings.instance.remainders;
                  ...
                  children: [
                    Dismissible(
                      ...
                      onDismissed: (direction) async {
                        if (direction == DismissDirection.startToEnd) {
                          await AlarmsAndSettings.instance.removeRemainder(
                            reminder.name,
                          );
                        }
                      },
                      ...
                      child: GestureDetector(
                        onTap: () {
                          AlarmsAndSettings.instance.toggleRemainder(reminder);
                        },
                        child: Container(
